...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference("Consultum.count") do
      post consulta_url, params: { consultum: { data: @consultum.data, horario: @consultum.horario, medico: @consultum.medico, paciente: @consultum.paciente } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { data: @consultum.data, horario: @consultum.horario, medico: @consultum.medico, paciente: @consultum.paciente } }
