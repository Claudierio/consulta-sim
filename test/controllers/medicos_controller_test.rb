...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference("Medico.count") do
      post medicos_url, params: { medico: { cpf: @medico.cpf, crm: @medico.crm, dataNascimento: @medico.dataNascimento, email: @medico.email, especialidade: @medico.especialidade, nome: @medico.nome } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { cpf: @medico.cpf, crm: @medico.crm, dataNascimento: @medico.dataNascimento, email: @medico.email, especialidade: @medico.especialidade, nome: @medico.nome } }
