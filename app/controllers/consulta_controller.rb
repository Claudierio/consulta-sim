class ConsultaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @consultum.save
        format.html { redirect_to consultum_url(@consultum), notice: "Consulta realizada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @consultum.update(consultum_params)
        format.html { redirect_to consultum_url(@consultum), notice: "Consulta atualizada." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to consulta_url, notice: "Consulta removida." }
