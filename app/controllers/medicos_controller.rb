class MedicosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @medico.save
        format.html { redirect_to medico_url(@medico), notice: "Medico Criado com sucesso!." }
  ...
  def update
    respond_to do |format|
      if @medico.update(medico_params)
        format.html { redirect_to medico_url(@medico), notice: "Medico Atualizado com sucesso!." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to medicos_url, notice: "Médico removido!." }
  ...
  private
    ...
    def medico_params
      params.require(:medico).permit(:nome, :dataNascimento, :cpf, :email, :especialidade, :crm)
    end
end
